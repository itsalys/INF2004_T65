...
#define RIGHT_ENCODER_VCC 14
// #define RIGHT_ENCODER_GND
#define LEFT_ENCODER_PIN 13
#define LEFT_ENCODER_VCC 12
#define LEFT_ENCODER_GND 11
...
void initEncoder( )
{
    gpio_init(RIGHT_ENCODER_VCC);
    gpio_set_dir(RIGHT_ENCODER_VCC, GPIO_OUT);
    gpio_put(RIGHT_ENCODER_VCC, 1);

    gpio_init(LEFT_ENCODER_VCC);
    gpio_set_dir(LEFT_ENCODER_VCC, GPIO_OUT);
    gpio_put(LEFT_ENCODER_VCC, 1);

    gpio_init(LEFT_ENCODER_GND);
    gpio_set_dir(LEFT_ENCODER_GND, GPIO_OUT);
    gpio_put(LEFT_ENCODER_GND, 0);
